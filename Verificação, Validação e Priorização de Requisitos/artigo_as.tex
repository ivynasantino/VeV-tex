...
É um processo menos rigoroso que o apresentado acima, onde costuma possuir de entre 3 e 5 participantes, com a possibilidade de desempenhar papel de autor, de líder de revisões ou de revisores.
...
\begin{enumerate}
    \item As necessidades dos clientes;
    \item A importância relativa dos requisitos para os clientes;
    \item O momento em que as capacidades precisam ser entregues;
    \item Requisitos que servem como predecessores para outros requisitos e outros relacionamentos entre requisitos;
    \item Quais requisitos devem ser implementados como um grupo;
    \item  O custo para satisfazer cada requisito.
\end{enumerate}
